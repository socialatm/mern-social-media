...
2. Clone the repo
   ```sh
   git clone https://github.com/socialatm/mern-social-media.git
   ```
...
See the [open issues](https://github.com/socialatm/mern-social-media/issues) for a full list of proposed features (and known issues).
...
[stars-url]: https://github.com/socialatm/mern-social-media/stargazers
